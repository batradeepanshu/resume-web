  ...
  constructor() {
    ...
    this.projects = [
      ...
      },
      {
        ...
        summary: "Embibe is an Ed-Tech startup which uses AI(Artificial Intelligence) to provide Personalized Education Packs for students preparing for various competetive exams.<p>The application's Front-End is made using React with Redux </p>",
        screenshots: [
          "choosemission",
          "embibe_home_page",
          "learn",

...
const PROD_DEV_STRINGS_MAP = {
  aboutMe: {
    development:
      "We come from the land of the ice and snow, From the midnight sun where the hot spring flows The hammer of the gods Well drive our ships to new lands To fight the horde, and sing and cry Valhalla, I am coming!",
    production:
      "I am a UI Developer based in Noida,India with 4 years of extensive experince in developing large and small Web applications ,with large MNCs and even startups.\r\n            <p> I work with the latest UI technologies to make responsive Web applications/PWAs which are :-</p>\r\n            <ul>\r\n            <li>high in performance</li>\r\n            <li>are scalable and maintainable</li>\r\n          </ul>"
  }
};
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <div
          className={
            "home-wrap transition-item " + (this.state.loading ? "hide" : "")
          }
          style={{ height: this.calculateHeight(homeHeight) }}
        >
          ...
          <div className="left-section col-md-6 col-xs-6 col-sm-6">
            <div className={window.innerWidth > 480 ? "me-container" : ""}>
              ...
              <img
                ...
                src={process.env.PUBLIC_URL + "/assets/me3.jpeg"}
              />
            </div>
          </div>
          <div className="right-section col-xs-6 col-md-6 col-sm-6">
            <div className={window.innerWidth > 480 ? "me-container2" : ""}>
              ...
              <div
                className="brief-about-me"
                dangerouslySetInnerHTML={{
                  __html: PROD_DEV_STRINGS_MAP.aboutMe[process.env.NODE_ENV]
                }}
              />
              <div className="res-wor-ski non-resp clearfix">
                <div
                  className="r-w-s animate"
                  onClick={this.changeRoute.bind(this, "/projects")}
                >
                  Projects
                </div>
                <div
                  className="r-w-s animate"
                  onClick={this.changeRoute.bind(this, "/skills")}
                >
                  Skills
                </div>
                <a
                  href={process.env.PUBLIC_URL + "/assets/resume.pdf"}
                  className="r-w-s green animate"
                >
                  Resume
                </a>
              </div>

...
class ResponsiveHeader extends Component {
  ...
  render() {
    return (
      <div
        className="resp responsive-header clearfix"
        ref={this.props.respHeaderRef}
      >
        ...
        <button
          className={
            ...
            (this.state.hamburgerOpen ? "is-active" : "")
          }
          onClick={this.openHamMenu.bind(this)}
          type="button"
        >
        ...
        <div
          className={
            ...
            (this.state.hamburgerOpen ? "-show" : "-hide")
          }
        >
          <div className="close-nav" onClick={this.openHamMenu.bind(this)}>
            x
          </div>
          <ul>
            ...
            <Link to="/skills" onClick={this.openHamMenu.bind(this)}>
              SKILLS
            </Link>
            <Link to="/experience" onClick={this.openHamMenu.bind(this)}>
              EXPERIENCE
            </Link>
